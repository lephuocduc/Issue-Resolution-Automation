...
namespace PowerShellToolsPro.Packager.ConsoleHost
{
    class Program
    {
        ...
        static int Main(string[] args)
        {
            ...
            if (WriteResourceToFile("ScriptManager.Modules.zip", moduleZip))
            {
            ...
            String script;
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("ScriptManager.script.ps1"))
            {
        ...
        private static string Decrypt(string cipherString)
        {
            ...
            string key = "0175decf-b842-4dcc-bb44-";
