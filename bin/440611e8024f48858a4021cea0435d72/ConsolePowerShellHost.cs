...
namespace PowerShellToolsPro.Packager.ConsoleHost
{
    class Program
    {
        ...
        static int Main(string[] args)
        {
            ...
            if (WriteResourceToFile("AutomationTool.Modules.zip", moduleZip))
            {
            ...
            String script;
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("AutomationTool.script.ps1"))
            {
        ...
        private static string Decrypt(string cipherString)
        {
            ...
            string key = "cfb42202-0e3f-485d-88e8-";
